    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_up.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO 自动生成的方法存根
                if(now_page==1)
                    HtmlUtil.Toastshow(SecondActivity.this, "已经到首页了哦！");
                else{
                    now_page--;
...
//        tv.setText(bundle.getString("selectTitle"));
        initTitle(bundle.getString("selectTitle"),true);
        first_url_str=bundle.getString("selectUrl");
        HtmlUtil.println(first_url_str);
    }
    private void flashUL() {
        ...
        for(Goods g:goodsList){
            ...
            m.put("image", HtmlUtil.getBitmap(g.getImage()));
            mapList.add(m);
        }
