...
import com.lanlengran.mycookbook.model.NormalCookDetailModel;
...
public class NormalCookDetailPresenter extends BasePresenter<INormalCookDetailActivity> implements INormalCookDetailPresenter{
    private INormalCookDetailModel normalCookDetailModel;
    private Handler handler=new Handler();
    @Override
    public void getDate() {
        normalCookDetailModel=new NormalCookDetailModel();
