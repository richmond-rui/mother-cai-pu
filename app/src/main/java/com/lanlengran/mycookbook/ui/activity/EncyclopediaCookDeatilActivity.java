...
import com.lanlengran.mycookbook.presenter.EncyclopediaCookDetailPresenter;
...
public class EncyclopediaCookDeatilActivity extends MVPBaseActivity<INormalCookDetailActivity,
        EncyclopediaCookDetailPresenter> implements INormalCookDetailActivity {
    ...
    @Override
    protected EncyclopediaCookDetailPresenter createPresenter() {
        return new EncyclopediaCookDetailPresenter();
    }

    private void initView() {
//        initTitle(getString(R.string.厨房百科));
