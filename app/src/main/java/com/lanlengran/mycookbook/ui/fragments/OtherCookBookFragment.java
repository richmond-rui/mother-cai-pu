...
public class OtherCookBookFragment extends MVPBaseFragment<INormalCookBookFragment, NormalCookBookPresenter> implements INormalCookBookFragment {
...
//                        Toast.makeText(mContext, "加载下一页", Toast.LENGTH_SHORT).show();
    ...
    public String getHomePageURL() {
        return "http://www.chinacaipu.com/menu/foreignshipu/";
    }
}
