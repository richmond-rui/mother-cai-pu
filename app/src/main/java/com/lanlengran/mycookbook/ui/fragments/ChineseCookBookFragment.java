...
public class ChineseCookBookFragment extends MVPBaseFragment<INormalCookBookFragment, NormalCookBookPresenter> implements INormalCookBookFragment {
    ...
    public ChineseCookBookFragment() {
...
//                        Toast.makeText(mContext, "加载下一页", Toast.LENGTH_SHORT).show();
    ...
    public String getHomePageURL() {
        return "http://www.chinacaipu.com/menu/chinacaipu/";
    }
}
